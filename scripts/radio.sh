...
# Author: Peter Host (www.oghme.com)
#
...
DAEMON_ARGS="/home/pi/radio/scripts/www.js" # path to your node.js server/app
                                            # NB: don't use ~/ in path

DESC="node.js radio web server"             # whatever fancy description you like

NODEUSER=www-data:www-data                 # USER who OWNS the daemon process (no matter whoever runs the init script)
